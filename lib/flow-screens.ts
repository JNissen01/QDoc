...
const TITLES: Record<StepId, { title: string; note?: string }> = {
  ...
  pronouns: { title: "Pronouns", note: "Phase 2 · 1/7" },
  sex: {
  ...
  pharmacy: { title: "Pharmacy", note: "Phase 2 · 2/7" },
  "family-doctor": { title: "Family doctor", note: "Phase 2 · 3/7" },
  biometrics: { title: "Biometrics", note: "Phase 2 · 4/7" },
  "medical-history": { title: "Medical history", note: "Phase 2 · 5/7" },
  medications: { title: "Medications", note: "Phase 2 · 6/7, gated" },
